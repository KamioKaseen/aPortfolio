...
const KnowledgeBase: FC = () => {
  ...
  return (
    <>
      <Header image='Baikal/baikal-header.png' />
      ...
      <main className='work'>
        ...
        <Image image='Baikal/baikal-botels.png'/>
        <Image image='Baikal/baikal-profile.png'/>
        <Image image='Baikal/baikal-colors.png'/>
        <Image image='Baikal/baikal-feed.png'/>
        <NavigationBar />
      </main>
    </>
  )
